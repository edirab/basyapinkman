...
<head>
  ...
  <title> Пока мы с тобой ехали </title>
...
<div class="navbar navbar-default">
  <div class="container-fluid">
	...
	<div class="row">
	 ...
	 <li><a href="../index.php">Главная</a></li>
	 <li><a href="../archive.php">Архив</a></li>
	 <li><a href="#">Пока мы с тобой ехали</a></li></ol>	<div class="row">
		<h1 class="h2 page-header">Пока мы с тобой ехали</h1>
		<div class="col-xs-12 col-sm-6 col-md-4">
				<img class="img-responsive" src="../img/poka_mi_s_toboj_ehali.jpg">
		</div>
		<div class="col-xs-12 col-sm-6 col-md-4">
	
		<p>
		Это не страшно, мама,<br />
Это лишь переход.<br />
Время течет вперед<br />
В море с материка.<br />
<br />
Слышится здесь любовь<br />
В каждом малейшем звуке.<br />
В эти родные руки<br />
Буду стремиться вновь.<br />
<br />
Ну а меня зовет<br />
Страж из высокой башни,<br />
Тронулся лед вчерашний,<br />
Солнце привел восход.<br />
<br />
В завтрашнем добром сне<br />
Сразу тебя замечу<br />
И устремлюсь навстречу.<br />
Помни, что смерти нет!<br />
;
		</p>
		</div>
...
<div class="container">
    <div class="row text-center">
		<ul class="pagination"><li class = "active"><a href="whilewego.php">&laquo;</a></li><li><a href="#">Страница 5 из 8</a></li><li class = "active"><a href="imlying.php">&raquo;</a></li>		</ul>
	</div>
</div></body>
</html>
