...
<div class="navbar navbar-default">
  <div class="container-fluid">
	...
	<div class="row">
	 ...
	 <li><a href="../index.php">Главная</a></li>
	 <li><a href="../archive.php">Архив</a></li>
	 <li><a href="#">О ящерицах</a></li></ol>	<div class="row">
		<h1 class="h2 page-header">О ящерицах</h1>
		<div class="col-xs-12 col-sm-6 col-md-4">
				<img class="img-responsive" src="../img/crocodile.jpg">
		</div>
		<div class="col-xs-12 col-sm-6 col-md-4">
...
<div class="container">
    <div class="row text-center">
		<ul class="pagination"><li><a href="#">Страница 1 из 8</a></li><li class = "active"><a href="envelope.php">&raquo;</a></li>		</ul>
	</div>
</div></body>
</html>
