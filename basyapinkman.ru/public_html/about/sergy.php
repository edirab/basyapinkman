...
<div class="row">
	<ol class="breadcrumb">
		...
		<li><a href="#"> Сергей Морозов </a></li>
	</ol>
		<h1 class="h2 page-header" style = "margin-left: 3%" >Сергей Викторович Морозов</h1>
	
	<div class="col-xs-12 col-sm-6 col-md-4">
				<img class="img-responsive" src="../img/sergy.jpg" id = "author">
	</div>
	
	<div class="col-xs-12 col-sm-6 col-md-8">
		<p class = "prose">
		Твой текст – мои ножницы (…а также карандаш, краски, пастель, photoshop, indesign и много других интересных слов).
		Делаю все, чтобы читатель, заглянув в книгу, не увидел там фигу (если это, конечно, не входит в авторский замысел).
		Люблю яблоки, косаток и курить.
		</p>
	</div>
