...
<head>
  ...
  <meta name="keywords" content="Пока мы с тобой ехали, Бася Пинкман, авторские стихотворения, авторские стихи, стихи современников, социальные стихи, острые стихи,
...
стихи социальной направленности, философия о жизни">
  <meta name="description" content="Пока мы с тобой ехали, Это не страшно, мама,
Это лишь переход.
Время течет вперед
В море с материка.
  ...
  <div class="container-fluid">
	...
	<div class="row">
	 ...
	 <li><a href="#">Пока мы с тобой ехали</a></li></ol>	<div class="row">
		<h1 class="h2 page-header" style="margin-left: 30px">Пока мы с тобой ехали</h1>
		<div class="col-xs-12 col-sm-6 col-md-4">
				<img class="img-responsive" style="margin-bottom: 20px" src="../img/whilewego.jpg">
		</div>
		<div class="col-xs-12 col-sm-6 col-md-4">
...
<div class="container">
    <div class="row text-center">
		<ul class="pagination"><li><a href="fragile.php">&laquo;</a></li><li class = "active"><a href="#">Страница 5 из 46</a></li><li><a href="elephant.php">&raquo;</a></li>		</ul>
	</div>
</div>
