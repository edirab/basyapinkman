...
<head>
  ...
  <meta name="keywords" content="Розово солнце, Бася Пинкман, авторские стихотворения, авторские стихи, стихи современников, социальные стихи, острые стихи,
...
стихи социальной направленности, философия о жизни">
  <meta name="description" content="Розово солнце, Розово солнце на нервах пылает,
Вселяя весну в запотевший рассудок.
На кухне из крана в">

  <title> Розово солнце </title>
...
<div class="navbar navbar-default">
  <div class="container-fluid">
	...
	<div class="row">
	 ...
	 <li><a href="../index.php">Главная</a></li>
	 <li><a href="../archive.php">Архив</a></li>
	 <li><a href="#">Розово солнце</a></li></ol>	<div class="row">
		<h1 class="h2 page-header" style="margin-left: 30px">Розово солнце</h1>
		<div class="col-xs-12 col-sm-6 col-md-4">
				<img class="img-responsive" style="margin-bottom: 20px" src="../img/pinksun.jpg">
		</div>
		<div class="col-xs-12 col-sm-6 col-md-4">
	
		<p style="margin-left: 5%; font-size: 1.2em">
		Розово солнце на нервах пылает,<br />
Вселяя весну в запотевший рассудок.<br />
На кухне из крана вода убегает,<br />
Струится, как кровь по тонким сосудам.<br />
И ветер простужено что-то бормочет,<br />
В трубе, в переулках играет дико,<br />
<br />
А грузный старик на базарной площади<br />
Своей ненаглядной украл гвоздику.<br />
Его старуха, некогда тонкая,<br />
Ветра перемен так тонко чувствует!<br />
Наверное, лучше чувствует только<br />
Корабль в порту слова напутствия.<br />
<br />
Старуха волнуется: щебет синицы<br />
На розовой кромке света и ночи.<br />
Старуха выходит во двор насладиться<br />
Тем утром, что ей консервировать хочется.<br />
<br />
Песочное время бежит сквозь суставы.<br />
Останься, время, минутой летней!<br />
Но в банке - компота чуть-чуть осталось<br />
На розовой кромке ночи и света.
		</p>
		</div>	<?php
	$basya_relative_path = '../';
...
<div class="container">
    <div class="row text-center">
		<ul class="pagination"><li><a href="summeriad.php">&laquo;</a></li><li class = "active"><a href="#">Страница 37 из 46</a></li><li><a href="sevastopol.php">&raquo;</a></li>		</ul>
	</div>
</div>
