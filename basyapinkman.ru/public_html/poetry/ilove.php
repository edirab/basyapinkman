...
<head>
  ...
  <meta name="keywords" content="Я люблю, Бася Пинкман, авторские стихотворения, авторские стихи, стихи современников, социальные стихи, острые стихи,
...
стихи социальной направленности, философия о жизни">
  <meta name="description" content="Я люблю, Я люблю тебя, моя клетка.
Я рожу тебя: плакать в жилетку.
Подберу все, что ты обронишь
И �">
...
<div class="navbar navbar-default">
  <div class="container-fluid">
	...
	<div class="row">
	 ...
	 <li><a href="../index.php">Главная</a></li>
	 <li><a href="../archive.php">Архив</a></li>
	 <li><a href="#">Я люблю</a></li></ol>	<div class="row">
		<h1 class="h2 page-header" style="margin-left: 30px">Я люблю</h1>
		<div class="col-xs-12 col-sm-6 col-md-4">
				<img class="img-responsive" style="margin-bottom: 20px" src="../img/ilove.jpg">
		</div>
		<div class="col-xs-12 col-sm-6 col-md-4">
	
		<p style="margin-left: 5%; font-size: 1.2em">
		Я люблю тебя, моя клетка.<br />
Я рожу тебя: плакать в жилетку.<br />
Подберу все, что ты обронишь<br />
И женю. Ты меня похоронишь.<br />
<br />
Я люблю тебя, мое тельце,<br />
Будет жить нам с тобой хотеться.<br />
Молока, и поспать, и с мамой<br />
(Самой-самой) смеяться в ванной.<br />
<br />
Я люблю тебя, мое тело,<br />
Не хочу, чтобы ты взрослело.<br />
Ведь вчера девчонка на лавке,<br />
Круглопузая, горько плакала.<br />
И качалась: ой люли, люли!<br />
Меня больше никто не любит.<br />
<br />
Я люблю тебя...Ненавижу!<br />
Я на лестничной клетке нижней.<br />
Я не помню...Нет, все я помню.<br />
Как я только дошла до дома...<br />
Но о том говорить не стану<br />
Даже маме. (Самой. Самой).<br />
<br />
Я люблю тебя мое тело.<br />
Родила всех, кого хотела.<br />
И кого хотела, простила.<br />
Побыла самой милой. Милой.<br />
<br />
Я люблю тебя, мое тело.<br />
Я хочу, чтобы ты постарело.<br />
Чтобы самым тяжелым артритом<br />
Все суставы были разбиты.<br />
Чтоб меня подводила память,<br />
Чтобы рот начал шамкать, картавить,<br />
Чтобы ночью вставать раз по двести,<br />
Чтобы это, и то не есть и...<br />
И очки, и челюсть вставная,<br />
И клюка, и нога стальная.<br />
<br />
Я старухой покладистой буду<br />
И согласна все это терпеть.<br />
Если мир свое явит чудо<br />
И отложит до старости смерть.<br />
<br />
Я люблю тебя, оболочка,<br />
Хоть хрупкА ты, и так непрОчна<br />
Ты дождись меня, я недолго:<br />
У меня билеты на Бога.
		</p>
		</div>	<?php
	$basya_relative_path = '../';
...
<div class="container">
    <div class="row text-center">
		<ul class="pagination"><li><a href="deathannouncement.php">&laquo;</a></li><li class = "active"><a href="#">Страница 12 из 46</a></li><li><a href="firstwilleat.php">&raquo;</a></li>		</ul>
	</div>
</div>
