...
<head>
  ...
  <meta name="keywords" content="Твой Стикс замерз, пришла зима, Бася Пинкман, авторские стихотворения, авторские стихи, стихи современников, социальные стихи, острые стихи,
...
стихи социальной направленности, философия о жизни">
  <meta name="description" content="Твой Стикс замерз, пришла зима, Твой Стикс замерз, пришла зима.
Ты, как в блокаду, люд по льду
Везешь, Харон, сложив в кар">

  <title> Твой Стикс замерз, пришла зима </title>
...
<div class="navbar navbar-default">
  <div class="container-fluid">
	...
	<div class="row">
	 ...
	 <li><a href="../index.php">Главная</a></li>
	 <li><a href="../archive.php">Архив</a></li>
	 <li><a href="#">Твой Стикс замерз, пришла зима</a></li></ol>	<div class="row">
		<h1 class="h2 page-header" style="margin-left: 30px">Твой Стикс замерз, пришла зима</h1>
		<div class="col-xs-12 col-sm-6 col-md-4">
				<img class="img-responsive" style="margin-bottom: 20px" src="../img/styx.jpg">
		</div>
		<div class="col-xs-12 col-sm-6 col-md-4">
	
		<p style="margin-left: 5%; font-size: 1.2em">
		Твой Стикс замерз, пришла зима.<br />
Ты, как в блокаду, люд по льду<br />
Везешь, Харон, сложив в карман<br />
Монеты. В нынешнем году<br />
<br />
На переправе, в лимб как в Крым,<br />
Мы заживем в очередях.<br />
Кто предпоследним был: вторым<br />
Окажется. Как на дрожжах<br />
<br />
Растем, а время канет вспять:<br />
Мы ждем, от бремени легки.<br />
Мы разучились умирать<br />
И класть на веки пятаки.<br />
<br />
Туман сгущается, и в нем<br />
Идти не страшно в мире грёз,<br />
Светя прожИтого огнем,<br />
Который ты с собой пронес.
		</p>
		</div>	<?php
	$basya_relative_path = '../';
...
<div class="container">
    <div class="row text-center">
		<ul class="pagination"><li><a href="kernel.php">&laquo;</a></li><li class = "active"><a href="#">Страница 21 из 46</a></li><li><a href="ieronim.php">&raquo;</a></li>		</ul>
	</div>
</div>
