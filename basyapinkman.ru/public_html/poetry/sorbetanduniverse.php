...
<head>
  ...
  <meta name="keywords" content="Сорбет и Вселенная, Бася Пинкман, авторские стихотворения, авторские стихи, стихи современников, социальные стихи, острые стихи,
...
стихи социальной направленности, философия о жизни">
  <meta name="description" content="Сорбет и Вселенная, По тарелке размажу я свой сорбет,
Как на завтрак овсянку в детстве.
Ты дождешься - однаж">

  <title> Сорбет и Вселенная </title>
...
<div class="navbar navbar-default">
  <div class="container-fluid">
	...
	<div class="row">
	 ...
	 <li><a href="../index.php">Главная</a></li>
	 <li><a href="../archive.php">Архив</a></li>
	 <li><a href="#">Сорбет и Вселенная</a></li></ol>	<div class="row">
		<h1 class="h2 page-header" style="margin-left: 30px">Сорбет и Вселенная</h1>
		<div class="col-xs-12 col-sm-6 col-md-4">
				<img class="img-responsive" style="margin-bottom: 20px" src="../img/sorbetanduniverse.jpg">
		</div>
		<div class="col-xs-12 col-sm-6 col-md-4">
	
		<p style="margin-left: 5%; font-size: 1.2em">
		По тарелке размажу я свой сорбет,<br />
Как на завтрак овсянку в детстве.<br />
Ты дождешься - однажды сойдут на нет,<br />
Все мечты о твоем соседстве.<br />
<br />
Как погода в Дувре, мой старый френд?<br />
Не с Атлантики ль ветры дуют<br />
Хочешь миром править - лови момент со словами:<br />
Come on, just do it.<br />
<br />
Ты же за руку просто меня веди,<br />
Ты умеешь, я знаю точно.<br />
В Океании - слышал? - опять дожди<br />
Ежедневно и еженощно.<br />
<br />
Я доем десерт - этот сладкий лед<br />
Зубы сводит мне неотвратно<br />
Так наш мир до точки себя сожмет,<br />
А потом развернет обратно.
		</p>
		</div>	<?php
	$basya_relative_path = '../';
...
<div class="container">
    <div class="row text-center">
		<ul class="pagination"><li><a href="pinkman.php">&laquo;</a></li><li class = "active"><a href="#">Страница 46 из 46</a></li>		</ul>
	</div>
</div>
