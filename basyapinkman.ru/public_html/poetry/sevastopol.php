...
<head>
  ...
  <meta name="keywords" content="Севастополь, Бася Пинкман, авторские стихотворения, авторские стихи, стихи современников, социальные стихи, острые стихи,
...
стихи социальной направленности, философия о жизни">
  <meta name="description" content="Севастополь, Поступь наощупь, ночь и безумно
Хочется спрятать бисер подальше...
Где-то огни, смеются ">
...
<div class="navbar navbar-default">
  <div class="container-fluid">
	...
	<div class="row">
	 ...
	 <li><a href="../index.php">Главная</a></li>
	 <li><a href="../archive.php">Архив</a></li>
	 <li><a href="#">Севастополь</a></li></ol>	<div class="row">
		<h1 class="h2 page-header" style="margin-left: 30px">Севастополь</h1>
		<div class="col-xs-12 col-sm-6 col-md-4">
				<img class="img-responsive" style="margin-bottom: 20px" src="../img/sevastopol.jpg">
		</div>
		<div class="col-xs-12 col-sm-6 col-md-4">
	
		<p style="margin-left: 5%; font-size: 1.2em">
		Поступь наощупь, ночь и безумно<br />
Хочется спрятать бисер подальше...<br />
Где-то огни, смеются и шум<br />
Руку, скорее, и прочь, мой мальчик.<br />
<br />
Эти там-тамы - уже серьезно,<br />
Значит война на соседнем поле.<br />
Это по сути уже не звезды -<br />
Это же души, не видишь чтоли?<br />
<br />
Город подталкивал улицы под ноги<br />
То-то я все спотыкалась и падала<br />
Смешно при том кувыркаясь в воздухе<br />
А ты каждый раз желанье загадывал.<br />
<br />
Огней дополнения и обстоятельства<br />
Чертят залива тревожную линию<br />
И может быть хватит словометательства<br />
Словами не выиграть битву длинную.<br />
<br />
А ты, на войне ведь! Мальчишкам весело...<br />
Небрежно спешился, выпил игристого<br />
(И так хорош - на стенку б повесила)<br />
Кивнул и замер на миг от выстрела.
		</p>
		</div>	<?php
	$basya_relative_path = '../';
...
<div class="container">
    <div class="row text-center">
		<ul class="pagination"><li><a href="pinksun.php">&laquo;</a></li><li class = "active"><a href="#">Страница 38 из 46</a></li><li><a href="1937.php">&raquo;</a></li>		</ul>
	</div>
</div>
