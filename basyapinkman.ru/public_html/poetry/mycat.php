...
<head>
  ...
  <meta name="keywords" content="Мой кот, Бася Пинкман, авторские стихотворения, авторские стихи, стихи современников, социальные стихи, острые стихи,
...
стихи социальной направленности, философия о жизни">
  <meta name="description" content="Мой кот, Мой кот, как корабль в порт, заходит на кухню,
Он главный эксперт по готовности суточных">
...
<div class="navbar navbar-default">
  <div class="container-fluid">
	...
	<div class="row">
	 ...
	 <li><a href="../index.php">Главная</a></li>
	 <li><a href="../archive.php">Архив</a></li>
	 <li><a href="#">Мой кот</a></li></ol>	<div class="row">
		<h1 class="h2 page-header" style="margin-left: 30px">Мой кот</h1>
		<div class="col-xs-12 col-sm-6 col-md-4">
				<img class="img-responsive" style="margin-bottom: 20px" src="../img/mycat.jpg">
		</div>
		<div class="col-xs-12 col-sm-6 col-md-4">
	
		<p style="margin-left: 5%; font-size: 1.2em">
		Мой кот, как корабль в порт, заходит на кухню,<br />
Он главный эксперт по готовности суточных щей, прожарке мяса и прочих подобных вещей, он носом едва повел и уже унюхал.<br />
Но кот, с недавних пор, бывает обставлен псом,<br />
Оставлен в семнадцатой степени дальше от цели, ведь пес - мишленовский критик в питательной цепи,<br />
Он чует с порога подъезда обед и молотит хвостом.
		</p>
		</div>	<?php
	$basya_relative_path = '../';
...
<div class="container">
    <div class="row text-center">
		<ul class="pagination"><li><a href="heresthebird.php">&laquo;</a></li><li class = "active"><a href="#">Страница 24 из 46</a></li><li><a href="innerimigration.php">&raquo;</a></li>		</ul>
	</div>
</div>
