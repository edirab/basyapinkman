...
<head>
  ...
  <meta name="keywords" content="Зона отчуждения, Бася Пинкман, авторские стихотворения, авторские стихи, стихи современников, социальные стихи, острые стихи,
...
стихи социальной направленности, философия о жизни">
  <meta name="description" content="Зона отчуждения, Я обручилась с мистером Хантингтоном
А лучше б с мистером Томпсоном (Хантером)
Я мечом ">

  <title> Зона отчуждения </title>
...
<div class="navbar navbar-default">
  <div class="container-fluid">
	...
	<div class="row">
	 ...
	 <li><a href="../index.php">Главная</a></li>
	 <li><a href="../archive.php">Архив</a></li>
	 <li><a href="#">Зона отчуждения</a></li></ol>	<div class="row">
		<h1 class="h2 page-header" style="margin-left: 30px">Зона отчуждения</h1>
		<div class="col-xs-12 col-sm-6 col-md-4">
				<img class="img-responsive" style="margin-bottom: 20px" src="../img/exclusionzone.jpg">
		</div>
		<div class="col-xs-12 col-sm-6 col-md-4">
	
		<p style="margin-left: 5%; font-size: 1.2em">
		Я обручилась с мистером Хантингтоном<br />
А лучше б с мистером Томпсоном (Хантером)<br />
Я мечом обрушилась, что замер над троном,<br />
Я отравилась Жан-Полем Сартром.<br />
<br />
Из всех возможных моих историй,<br />
Из всех возможных моих событий,<br />
Оставить хочу я беседы с морем<br />
И пару-другую случайных соитий.<br />
<br />
Бокалы вверх за журналистику Гонзо!<br />
Кто, если не ты, полезет в пещеру?<br />
Пей до последнего майские грозы,<br />
С чистой душой лети в экзосферу.<br />
<br />
До тошноты, до страха и ненависти<br />
Есть еще чувства на этом свете.<br />
Плясок святого Витта прелесть<br />
Еще не раскинула свои сети.
		</p>
		</div>	<?php
	$basya_relative_path = '../';
...
<div class="container">
    <div class="row text-center">
		<ul class="pagination"><li><a href="losttime.php">&laquo;</a></li><li class = "active"><a href="#">Страница 27 из 46</a></li><li><a href="tothedevilason.php">&raquo;</a></li>		</ul>
	</div>
</div>
