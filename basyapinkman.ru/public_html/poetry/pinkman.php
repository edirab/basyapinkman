...
<head>
  ...
  <meta name="keywords" content="Пинкман, Бася Пинкман, авторские стихотворения, авторские стихи, стихи современников, социальные стихи, острые стихи,
...
стихи социальной направленности, философия о жизни">
  <meta name="description" content="Пинкман, Ты до жил докопаешься, сразу язык развяжешь.
Только что ты резину тянешь, уже не тащишь.">
...
<div class="navbar navbar-default">
  <div class="container-fluid">
	...
	<div class="row">
	 ...
	 <li><a href="../index.php">Главная</a></li>
	 <li><a href="../archive.php">Архив</a></li>
	 <li><a href="#">Пинкман</a></li></ol>	<div class="row">
		<h1 class="h2 page-header" style="margin-left: 30px">Пинкман</h1>
		<div class="col-xs-12 col-sm-6 col-md-4">
				<img class="img-responsive" style="margin-bottom: 20px" src="../img/pinkman.jpg">
		</div>
		<div class="col-xs-12 col-sm-6 col-md-4">
	
		<p style="margin-left: 5%; font-size: 1.2em">
		Ты до жил докопаешься, сразу язык развяжешь.<br />
Только что ты резину тянешь, уже не тащишь.<br />
Оторвешься как лист по осени от осины<br />
Там буран за Стеной занесет, взгляд твой станет синим.<br />
<br />
Отвернулся, ушел, не трепи, что это проверка .<br />
Только я без тебя как Пинкман без Хайзенберга.<br />
Я как матерь драконов без самого злого - черного.<br />
Никому ни сказать, ни соврать - время чертово.<br />
<br />
Нет нормально, работаем, как всегда над кармой:<br />
Я сама себе Клара, Карл, и сама себе Карл я.<br />
Только пару ухмылок смахну, после третьего шота:<br />
Где-то колокол, бьют в набат. Суббота.
		</p>
		</div>	<?php
	$basya_relative_path = '../';
...
<div class="container">
    <div class="row text-center">
		<ul class="pagination"><li><a href="orwellletter.php">&laquo;</a></li><li class = "active"><a href="#">Страница 45 из 46</a></li><li><a href="sorbetanduniverse.php">&raquo;</a></li>		</ul>
	</div>
</div>
