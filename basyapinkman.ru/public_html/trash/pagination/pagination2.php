<?php
    ...
    $rows_max = 34; // Сколько всего новостей у нас в базе
    $show_pages = 4; // Сколько новостей покажем пользователю
    $this_page = 5; // Номер текущей страницы
    ...
    while ($row = mysql_fetch_assoc($final_result)) {  
        echo '<center>
				<div id="novosti"><table border="0" width="706"><td><strong>
					<center> <div id="novostin">
						<div id="novostip">'.$row["name"].'</a><br />
						</div>
							<hr></hr>
					</center>
				</strong><div id="novostit">' ;
