...
sys.path.insert(0, '/home/hosting_edirab/projects/basyapinkman-python-uwsgi/basyapinkman')
sys.path.insert(0, '/home/hosting_edirab/projects/basyapinkman-python-uwsgi')
